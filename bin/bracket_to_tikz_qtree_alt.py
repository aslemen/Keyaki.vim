...
\usepackage[a4paper,margin=0in,bottom=.3in,foot=.2in,landscape]{geometry}
\usepackage[whole]{bxcjkjatype}
\\begin{document}
\\resizebox{.97\\textwidth}{!}{\\sf
\\begin{tabular}{l}
YIELD-HERE
''' % self.doc_opt
...
def parse_options():
  ...
  parser.add_option('--doc-option', dest='doc_opt', default='article',
